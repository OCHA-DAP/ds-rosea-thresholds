...
BLOB_WORLDPOP_FILE = f"{BLOB_RAW_PATH}/worldpop2020_unAdj_zonal_sum_ROSEA.csv"
...
BLOB_MONTHLY_EXPOSURE_FILE = f"{BLOB_THRESHOLD_ANALYSIS_DIR}/monthly_country_exposure.csv"
