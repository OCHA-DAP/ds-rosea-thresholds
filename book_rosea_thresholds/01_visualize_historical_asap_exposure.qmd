...
This notebook analyzes historical population exposure to agricultural warnings across 15 countries in East & Southern Africa. Here we just use the month of July as an example, but this same analysis would need to be done per month to set thresholds based on historical exposure to different degrees of ASAP severity classifications.
